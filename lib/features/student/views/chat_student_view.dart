...
class ChatStudentView extends StatelessWidget {
  const ChatStudentView({super.key});
            ...
            child: ListView(
              ...
              children: const [
                ...
                _MessageBubble(
                  isMe: false,
                  isTeacher: true,
                  message: 'Jam berapa kamu sampai di sekolah?',
                ...
                _MessageBubble(
                  isMe: true,
                  isTeacher: false,
                  message: 'Saya sampai sekolah jam 06.35',
                  // Ganti dengan URL avatar murid
                  avatarUrl:
                      'https://placehold.co/100x100/FFE0E9/333333?text=M',
